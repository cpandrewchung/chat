...
@class FBSDKAccessToken, SKYConversation, SKYConversationChange, SKYMessage, SKYUserChannel, SKYLastMessageRead,SKYChatUser;
...
typedef void (^SKYContainerGetConversationListActionCompletion)(NSArray<SKYConversation*> *conversationList, NSError *error);
...
- (void)createConversationWithParticipantIds:(NSMutableArray *)participantIds withAdminIds:(NSMutableArray *)adminIds withTitle:(NSString *)title completionHandler:(SKYContainerConversationOperationActionCompletion)completionHandler;
...
-(void)createMessageWithConversationId:(NSString *)conversationId withBody:(NSString *)body withURL:(NSURL *)url withType:(SKYChatMetaDataType)type completionHandler:(SKYContainerMessageOperationActionCompletion)completionHandler;//not finished
